...
The full definition are available in \htmladdnormallink{\texttt{types.py}}{http://code.google.com/p/rl-glue-ext/source/browse/trunk/projects/codecs/Matlab/src/rlglue/types.py}.
\subsection{Functions}
\subsubsection{Agent Functions}
All agents \textbf{should implement} \htmladdnormallink{\texttt{rlglue.agent.Agent}}{http://code.google.com/p/rl-glue-ext/source/browse/trunk/projects/codecs/Matlab/src/rlglue/agent/Agent.py}.

\subsubsection{Environment Functions}
All environments \textbf{should implement} \htmladdnormallink{\texttt{rlglue.environment.Environment}}{http://code.google.com/p/rl-glue-ext/source/browse/trunk/projects/codecs/Matlab/src/rlglue/environment/Environment.py}.

\subsubsection{Experiments Functions}
All experiments \textbf{can call} the methods in \htmladdnormallink{\texttt{rlglue.RLGlue}}{http://code.google.com/p/rl-glue-ext/source/browse/trunk/projects/codecs/Matlab/src/rlglue/RLGlue.py}.
