...
PARAMETERS:
    agent             : agent object in use [rl-glue:agent]
    first-observation : 1st observation of an episode [rl-glue:observation]
...
PARAMETERS:
    agent       : agent object in use [rl-glue:agent]
    reward      : obtained reward [double-float]
    observation : resulting observation [rl-glue:observation]
...
PARAMETERS:
    agent  : agent object in use [rl-glue:agent]
    reward : last reward of an episode [double-float]
