...
\lispprompt{(defmethod env-save-state ((env my-env)) \ldots)} \\
\lispprompt{(defmethod env-load-state ((env my-env) state-key) \ldots)} \\
\lispprompt{(defmethod env-save-random-seed ((env my-env)) \ldots)} \\
\lispprompt{(defmethod env-load-random-seed ((env my-env) random-seed-key) \ldots)} \\
...
\prompttext{rl-save-state},
\prompttext{rl-load-state},
\prompttext{rl-save-random-seed}, \\
\prompttext{rl-load-random-seed},
