...
(defun gen-adt-array (make-fn size elem-gen-fn)
...
(defun fill-adt (adt &key ints floats chars)
  ...
  (with-accessors ((iarr int-array) (farr float-array) (cstr char-string)) adt
    (when ints
      (setf iarr (gen-adt-array #'(lambda (size initial-contents)
                                    (make-int-array size
                                                    :initial-contents
                                                    initial-contents))
                                ints
                                #'(lambda (i) i))))
    (when floats
      (setf farr (gen-adt-array #'(lambda (size initial-contents)
    ...
    (when chars
      (setf cstr (gen-adt-array #'(lambda (size initial-contents)
                                    (make-array size
