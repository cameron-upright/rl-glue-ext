...
The documentation of this codec can be found in the readme files of the
directories.
...
The examples directory contains a shy agent, environment and experiment
implementation which shows how the codec can be used.
