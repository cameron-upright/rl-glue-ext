...
\htmladdnormallink{mines
 environment}{http://code.google.com/p/rl-glue-ext/source/browse/trunk/projects/codecs/C/examples/mines-sarsa-example/SampleMinesEnvironment.c} 
...
\label{sarsa-sample}
The 
\htmladdnormallink{SARSA agent}{http://code.google.com/p/rl-glue-ext/source/browse/trunk/projects/codecs/C/examples/mines-sarsa-example/SampleSarsaAgent.c}
