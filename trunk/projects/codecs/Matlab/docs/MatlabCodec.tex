...
\title{RL-Glue Matlab Codec 1.02 Manual }
...
\subsection{Limitation: One Agent or Environment or Experiment per Matlab Instance}
\label{one-at-a-time}
...
\label{mines-sample}
The 
\htmladdnormallink{mines environment}{http://code.google.com/p/rl-glue-ext/source/browse/trunk/projects/codecs/Matlab/examples/mines-sarsa-sample/sample_mines_environment.m} 
...
\label{sarsa-sample}
The 
\htmladdnormallink{SARSA agent}{http://code.google.com/p/rl-glue-ext/source/browse/trunk/projects/codecs/Matlab/examples/mines-sarsa-sample/sample_sarsa_agent.m}
